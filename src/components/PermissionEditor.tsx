...
const MODULES = ['farmers', 'dealers', 'distributors', 'fpos', 'sales_executives', 'routes','attendance','expenses','locations','shifts','farm_diary_masters','fspp_approvals', 'retail', 'farm_diary_approvals'];
